...
#ifndef DOTPREVIEWWIDGET_H
#define DOTPREVIEWWIDGET_H
...
public:
    explicit DotPreviewWidget(QObject* parent = nullptr);
    ~DotPreviewWidget() override;
...
private:
    KParts::ReadOnlyPart* m_graphViewerPart = nullptr;
