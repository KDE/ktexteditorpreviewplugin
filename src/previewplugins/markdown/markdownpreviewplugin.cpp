...
K_PLUGIN_FACTORY_WITH_JSON(MarkdownPreviewPluginFactory, "markdownpreviewplugin.json", registerPlugin<MarkdownPreviewPlugin>();)
...
#include "markdownpreviewplugin.moc"
